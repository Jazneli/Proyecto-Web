<?php
    ...
    if(isset($_SESSION["admin"])){
        ...
        $sqlAlumno = "SELECT * FROM alumno";
        $resAlumno = mysqli_query($conexion, $sqlAlumno);
        $infAlumno = mysqli_fetch_row($resAlumno);
        $txtIntroduccion = "Este reporte contiene todos los registros existentes en el sistema";

        $pdf = new PDF();
        $pdf->AddPage();
        $pdf->SetFont('Arial','B',15);
        $pdf->Ln(10);
        $pdf->Cell(0,7,utf8_decode("Reporte de alumnos en sistema"),0,1,"C");
